    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-16 text-center md:px-6 md:py-20">
      <div className="card p-10">
        ...
        <p className="mt-3 text-sm text-deep/70">
          Your order number is <strong>#{orderId}</strong>. We will contact you shortly to arrange
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          ...
          <Link href="/contact" className="rounded-full border border-deep/20 px-6 py-3 text-xs uppercase tracking-[0.2em]">
            Contact us
          </Link>
        </div>
      </div>
